KDsl.microapp :html_multi_page do
  settings do
    name                          parent.key
    app_type                      'WebpackApp'
    title                         'Html Multi Page'
    description                   'Html Multi Page using Webpack 5'
    application                   'HtmlMultiPage'
    git_repo_name                 'HtmlMultiPage'
    git_organization              'klueless-webpack5-samples'
    avatar                        'SPA Developer'
    main_story                    'As a SPA Developer, I want to have multiple html pages with separated assets, so that I can build a multi page site'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    author_website                'https://appydave.com'
    copyright_date                '2021'
    website                       'http://appydave.com/webpack5/by-example/html-multi-page'
    application_lib_path          'HtmlMultiPage'
    namespace_root                'HtmlMultiPage'
    template_rel_path             'html'
    app_path                      '~/dev/webpack5/HtmlMultiPage'
    data_path                     '_/.data'
    run_section                   99
  end
  ...
  def on_action
    ...
    when 3 # Setup WebPack V4 for now
      ...
      rc 'npx npe scripts.build:production "webpack --mode production"'
    ...
    when 20 # Install CSS & SASS loaders
      rc 'npm i -D css-loader style-loader'
      rc 'npm i -D sass-loader sass'
