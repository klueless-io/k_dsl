KDsl.microapp :transpiler_typescript do
  settings do
    name                          parent.key
    app_type                      'WebpackApp'
    title                         'Transpiler Typescript'
    description                   'Transpiler Typescript using Webpack 5'
    application                   'TranspilerTypescript'
    git_repo_name                 'TranspilerTypescript'
    git_organization              'klueless-webpack5-samples'
    avatar                        'SPA Developer'
    main_story                    'As a SPA Developer, I want use TypeScript, so that I can take advantage of strongly typed Javascript'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    author_website                'https://appydave.com'
    copyright_date                '2021'
    website                       'http://appydave.com/webpack5/by-example/transpiler-typescript'
    application_lib_path          'TranspilerTypescript'
    namespace_root                'TranspilerTypescript'
    template_rel_path             'html'
    app_path                      '~/dev/webpack5/TranspilerTypescript'
    data_path                     '_/.data'
    run_section                   6
  end
  ...
  # run.rake: project_webpack5_transpiler_typescript = build_project('webpack5/transpiler_typescript')
