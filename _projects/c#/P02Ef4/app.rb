...
KDsl.microapp :p02ef4 do
  settings do
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/csharp/samples/p02ef4'
    application_lib_path          'P02Ef4'
    namespace_root                'P02Ef4'
  ...
  def on_action
    s = d.settings
    # github_delete_repo s.git_repo_name, organization: 'klueless-csharp-samples'
    # github_new_repo s.git_repo_name, organization: 'klueless-csharp-samples'
    # run_command 'dotnet new console -n P02Ef4 -o .'
    ...
    # new_archetype :garden, :model, definition_subfolder: 'csharp-console', f: true
    new_archetype :bed, :model, definition_subfolder: 'csharp-console', f: true
