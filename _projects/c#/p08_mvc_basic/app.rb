...
KDsl.microapp :p08_mvc_basic do
  settings do
    name                          parent.key
    app_type                      'C# MVC app'
    description                   'P08 Mvc Basic simple mvc app provides a patterns-based way to build dynamic websites that enables a clean separation of concerns'
    application                   'P08MvcBasic'
    git_repo_name                 'P08MvcBasic'
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/csharp/samples/p08-mvc-basic'
    application_lib_path          'P08MvcBasic'
    namespace_root                'P08MvcBasic'
    template_rel_path             'csharp-mvc'
    app_path                      '~/dev/c#/P08MvcBasic'
    data_path                     '_/.data'
  end

  is_run = 1

  # run.rake: project_cs_p08_mvc_basic = build_project('c#/p08_mvc_basic')
  ...
  def on_action
    ...
    # run_command 'dotnet new mvc -n P08MvcBasic -o .'
