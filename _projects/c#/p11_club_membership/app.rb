...
KDsl.microapp :p11_club_membership do
  settings do
    name                          parent.key
    app_type                      'C# MVC app'
    description                   'P11 Club Membership Membership management system for a Sydney Club'
    application                   'P11ClubMembership'
    git_repo_name                 'P11ClubMembership'
    git_organization              'klueless-csharp-samples'
    avatar                        'Club Owner'
    main_story                    'As a Club Owner, I want to record and find member details, so I know who is in my club'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/csharp/samples/p11-club-membership'
    application_lib_path          'P11ClubMembership'
    namespace_root                'P11ClubMembership'
  ...
  # run.rake: project_cs_p11_club_membership = build_project('c#/p11_club_membership')
  ...
  def on_action
    ...
    run_command 'dotnet new mvc -n P11ClubMembership -o .'
