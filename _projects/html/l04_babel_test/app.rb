...
KDsl.microapp :l04_babel_test do
  settings do
    name                          parent.key
    app_type                      'HTML App'
    title                         'L04 Babel Test'
    description                   'L04 Babel Test in HTML'
    application                   'L04BabelTest'
    git_repo_name                 'L04BabelTest'
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/html/samples/l04-babel-test'
    application_lib_path          'L04BabelTest'
    namespace_root                'L04BabelTest'
    template_rel_path             'html'
    app_path                      '~/dev/html/L04BabelTest'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    # run_command 'npm install --save @babel/plugin-transform-arrow-functions'    # https://babeljs.io/docs/en/plugins/
