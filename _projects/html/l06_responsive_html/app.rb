...
KDsl.microapp :l06_responsive_html do
  settings do
    name                          parent.key
    app_type                      'HTML App'
    title                         'L06 Responsive Html'
    description                   'L06 Responsive Html in HTML'
    application                   'L06ResponsiveHtml'
    git_repo_name                 'L06ResponsiveHtml'
    git_organization              'klueless-html-samples'
    avatar                        'UX Designer'
    main_story                    'As a HTML Developer, I want to create responsive websites easily, so that I can be productive'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/html/samples/l06-responsive-html'
    application_lib_path          'L06ResponsiveHtml'
    namespace_root                'L06ResponsiveHtml'
    template_rel_path             'html'
    app_path                      '~/dev/html/L06ResponsiveHtml'
    data_path                     '_/.data'
  end

  is_run = 1

  # run.rake: project_html_l06_responsive_html = build_project('html/l06_responsive_html')
  def on_action
    s = d.settings
