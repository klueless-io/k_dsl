...
KDsl.microapp :printspeak do
  settings do
    name                          parent.key
    app_type                      'C# MVC app'
    description                   'Printspeak Printspeak enterprise in C#'
    application                   'Printspeak'
    git_repo_name                 'Printspeak'
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/csharp/samples/printspeak'
    application_lib_path          'Printspeak'
    namespace_root                'Printspeak'
    template_rel_path             'csharp-mvc'
    # app_path                      '~/dev/csharp/Printspeak'
    app_path                      '~/dev/csharp/Printspeak/Printspeak.Data'
    data_path                     '_/.data'
  end

  is_run = 1

  # run.rake: project_cs_printspeak = build_project('c#/printspeak')
  ...
  def on_action
    ...
    # run_command 'dotnet new classlib -n Printspeak.Data -o .'
    # run_command 'dotnet new mvc -n Printspeak -o .'
