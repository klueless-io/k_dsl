...
KDsl.document :stories do
  # Epic:
  # As a Print franchisee, I want to market my business effectively, so that my business is profitable
  ...
  table :stories do
    ...
    row :story, :current, 'As a Franchisee, I can DO_SOMETHING, so that I QUALITY_OF_LIFE',
    [
      'Subtask'
    ], featured_position: 1
