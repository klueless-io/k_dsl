...
KDsl.microapp :k_log do
  settings do
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-log'
    application_lib_path          'k_log'
    application_lib_namespace     'KLog'
    application_lib_namespaces    ['KLog']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_log'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    run_command 'bundle gem --coc --test=rspec --mit k_log', command_creates_top_folder: true
    run_command 'code .'
