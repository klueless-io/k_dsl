...
KDsl.microapp :k_fileset do
  settings do
    ruby_version                  '2.7.2' # Need a service that can return this information for me at the time of creating the project

    name                          parent.key
    app_type                      'Ruby Gem'
    description                   'K-Fileset provides file system snapshot using GLOB inclusions and exclusions'
    application                   'k_fileset'
    avatar                        'Developer'
    main_story                    'As a Developer, I want a path/file snapshot files on a computer, so I can access and manipulate files matching my pattern'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2022'
    website                       'http://appydave.com/gems/k-fileset'
    application_lib_path          'k_fileset'
    application_lib_namespace     'KFileset'
    application_lib_namespaces    ['KFileset']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_fileset'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    # run_command 'bundle gem --coc --test=rspec --mit k_fileset', command_creates_top_folder: true
    # run_command 'code .'
