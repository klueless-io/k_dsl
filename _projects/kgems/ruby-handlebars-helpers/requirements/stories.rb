...
KDsl.document :stories do
  ...
  table :stories do
    ...
    [
      'Build and deploy gem to [rubygems.org](https://rubygems.org/gems/ruby-handlebars-helpers)',
      'Attach documentation to [rubydoc.info](https://rubydoc.info/github/to-do-/ruby-handlebars-helpers/master)'
    ]
