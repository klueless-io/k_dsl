KDsl.blueprint :bootstrap_upgrade do
  ...
  instructions do
    ...
    row 'lib/applet_name.rb'              , 'lib/k_util.rb'          , after_write: 'prettier'
    row 'lib/applet_name/version.rb'      , 'lib/k_util/version.rb'  , after_write: 'prettier'

    row 'spec/spec_helper.rb'
    row 'spec/applet_name_spec.rb'        , 'spec/k_util_spec.rb'
    
    row '.rspec'
    row '.rubocop.yml'
    row '.travis.yml'                     , command: 'delete', note: 'this was generated by bundle gem'
    row 'applet_name.gemspec'             , 'k_util.gemspec'
  ...
  def on_action
    ...
    # hotfix 'Upgrade default readme and ruby files, plus add support for, rubocop, guard to k_util'
  end if is_run == 1
