...
KDsl.microapp :k_util do
  settings do
    ...
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-util'
    application_lib_path          'k_util'
    application_lib_namespace     'KUtil'
    application_lib_namespaces    ['KUtil']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_util'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    run_command 'bundle gem --coc --test=rspec --mit k_util', command_creates_top_folder: true
    run_command 'code .'
