KDsl.blueprint :parameter_info do
  ...
  table :attributes do
    ...
    row :name                 , 'name of the parameter'
    row :type                 , 'type of the parameter'
    row :signature_format     , 'ruby code format when used in a signature'
    row :minimal_call_format  , 'minimal required usage in a call to the method with this paramater'
  end
