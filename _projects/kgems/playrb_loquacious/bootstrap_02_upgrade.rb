KDsl.blueprint :bootstrap_upgrade do
  ...
  instructions do
    ...
    row 'lib/applet_name.rb'              , 'lib/playrb_loquacious.rb'
    row 'lib/applet_name/version.rb'      , 'lib/playrb_loquacious/version.rb', conflict: 'skip'

    row 'spec/spec_helper.rb'
    row 'spec/applet_name_spec.rb'        , 'spec/playrb_loquacious_spec.rb'
    
    row '.rspec'
    row '.rubocop.yml'
    row '.travis.yml'                     , command: 'delete', note: 'this was generated by bundle gem'
    row 'applet_name.gemspec'             , 'playrb_loquacious.gemspec'
