...
KDsl.document :backlog do
  ...
  table :backlog do
    ...
    row :task, :backlog, 'xadd DSL for settings'
    row :task, :backlog, 'xadd DSL for table and rows'
    row :task, :backlog, 'xadd DSL for data structure'
    row :task, :backlog, 'xadd document to wrap around the data structure'
