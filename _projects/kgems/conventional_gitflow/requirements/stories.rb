...
KDsl.document :stories do
  ...
  table :stories do
    ...
    [
      'Build and deploy gem to [rubygems.org](https://rubygems.org/gems/conventional_gitflow)',
      'Attach documentation to [rubydoc.info](https://rubydoc.info/github/to-do-/conventional_gitflow/master)'
    ]
