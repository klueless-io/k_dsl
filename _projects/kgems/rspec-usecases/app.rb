...
KDsl.microapp :rspec_usecases do
  ...
  def on_action
    ...
    # Requirements
    # new_blueprint :backlog                  , definition_subfolders: ['ruby-gem', 'requirements'], output_subfolder: 'requirements', show_editor: true, f: true
    # new_blueprint :stories                  , definition_subfolders: ['ruby-gem', 'requirements'], output_subfolder: 'requirements', show_editor: true, f: true
