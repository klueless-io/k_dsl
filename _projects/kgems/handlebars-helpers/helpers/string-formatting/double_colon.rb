KDsl.blueprint :double_colon do
  microapp = import(:handlebars_helpers, :microapp)

  s = settings do
    name                  'double_colon'
    description           "double_colon notation for the characters in the given 'string'. aka ruby namespace"
    result                "value converted to double_colon notation"
