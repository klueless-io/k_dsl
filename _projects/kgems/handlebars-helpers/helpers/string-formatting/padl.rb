KDsl.blueprint :padl do
  microapp = import(:handlebars_helpers, :microapp)

  s = settings do
    name                  'padl'
    description           "Add padding to the left of the value."
    result                "value with padding to left"
    ...
    test_case(            { params: [
                              ...
                              {name: 'count', type: 'Integer', sample_value: '10', description: 'how much padding to apply. defaults to configuration.padl_count'},
                              {name: 'char', type: 'String', sample_value: '-', description: 'character to pad with. defaults to configuration.padl_char'}
                            ],
