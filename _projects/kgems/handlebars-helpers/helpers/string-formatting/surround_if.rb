KDsl.blueprint :surround_if do
  microapp = import(:handlebars_helpers, :microapp)

  s = settings do
    name                  'surround_if'
    description           "Surround If will surround a value with prefix and suffix, if value is not empty"
    result                "prefix + value + suffix when value exists, otherwise ''"
