KDsl.blueprint :gte do
  microapp = import(:handlebars_helpers, :microapp)

  s = settings do
    name                  'gte'
    description           "Gte: (greater than or equal to) Block helper that renders a block if `a` is **greater than** `b`. If an inverse block is specified it will be rendered when falsy."
