KDsl.blueprint :or do
  microapp = import(:handlebars_helpers, :microapp)

  s = settings do
    name                  'or'
    description           'Or: Block helper that renders a block if **any of** the given values is truthy. If an inverse block is specified it will be rendered when falsy.'
    result                "return block when first value is truthy"
    category              'comparison'
    ...
    example_input_value   'var1 or var2'
    example_output_value  'truthy block'
    test_input_value      'var1 or var2'
