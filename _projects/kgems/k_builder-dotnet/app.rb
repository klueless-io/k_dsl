...
KDsl.microapp :k_builder_dotnet do
  settings do
    ruby_version                  '2.7.2' # Need a service that can return this information for me at the time of creating the project

    name                          parent.key
    app_type                      'Ruby Gem'
    description                   'K Builder Dotnet provides various fluent builders for building dotnet assets, specifically for c#'
    application                   'k_builder-dotnet'
    avatar                        'C# Developer'
    main_story                    'As a C# Developer, I want to generate dotnet code, projects and solutions quickly, so I build repeating patterns quickly'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-builder-dotnet'
    application_lib_path          'k_builder/dotnet'
    application_lib_namespace     'KBuilder::Dotnet'
    application_lib_namespaces    ['KBuilder', 'Dotnet']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_builder-dotnet'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    # run_command 'bundle gem --coc --test=rspec --mit k_builder-dotnet', command_creates_top_folder: true
    # run_command 'code .'
