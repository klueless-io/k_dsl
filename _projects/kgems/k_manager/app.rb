...
KDsl.microapp :k_manager do
  settings do
    ruby_version                  '2.7.2' # Need a service that can return this information for me at the time of creating the project

    name                          parent.key
    app_type                      'Ruby Gem'
    description                   'K Manager provides a managed host for documents, resources and code generator execution'
    application                   'k_manager'
    avatar                        'Developer'
    main_story                    'As a Developer, I need to generate code and handle complex data modeling, so I can generate complete applications quickly'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-manager'
    application_lib_path          'k/manager'
    application_lib_namespace     'K::Manager'
    application_lib_namespaces    ['K Manager']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_manager'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    run_command 'bundle gem --coc --test=rspec --mit k_manager', command_creates_top_folder: true
    run_command 'code .'
