...
KDsl.microapp :k_ext_github do
  settings do
    ruby_version                  '2.7.2' # Need a service that can return this information for me at the time of creating the project

    name                          parent.key
    app_type                      'Ruby Gem'
    description                   'KExt/Github provides useful github extensions specifically for the klueless code generator'
    application                   'k_ext-github'
    avatar                        'Developer'
    main_story                    'As a Developer, I need manage github repositories, so that my code is version controlled'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-ext-github'
    application_lib_path          'k_ext/github'
    application_lib_namespace     'KExt::Github'
    application_lib_namespaces    ['KExt', 'Github']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_ext-github'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    run_command 'bundle gem --coc --test=rspec --mit k_ext-github', command_creates_top_folder: true
    run_command 'code .'
