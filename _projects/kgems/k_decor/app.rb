...
KDsl.microapp :k_decor do
  settings do
    ruby_version                  '2.7.2' # Need a service that can return this information for me at the time of creating the project

    name                          parent.key
    app_type                      'Ruby Gem'
    description                   'KDecor provides decorators and management for applying data decoration to data objects'
    application                   'k_decor'
    avatar                        'Developer'
    main_story                    'As a Data Modeler, I need to enhance/annotate data models using data decorators, so that repeatable data patterns are applied automatically'
    author                        'David Cruwys'
    author_email                  'david@ideasmen.com.au'
    copyright_date                '2021'
    website                       'http://appydave.com/gems/k-decor'
    application_lib_path          'k_decor'
    application_lib_namespace     'KDecor'
    application_lib_namespaces    ['KDecor']
    template_rel_path             'ruby-gem'
    app_path                      '~/dev/kgems/k_decor'
    data_path                     '_/.data'
  end
  ...
  def on_action
    ...
    # run_command 'bundle gem --coc --test=rspec --mit k_decor', command_creates_top_folder: true
    # run_command 'code .'
