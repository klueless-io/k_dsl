KDsl.blueprint :bootstrap_upgrade do
  ...
  instructions do
    ...
    row 'lib/applet_name.rb'              , 'lib/k_builder/webpack5.rb'          , after_write: 'prettier'
    row 'lib/applet_name/version.rb'      , 'lib/k_builder/webpack5/version.rb'  , after_write: 'prettier'

    row 'spec/spec_helper.rb'
    row 'spec/applet_name_spec.rb'        , 'spec/k_builder/webpack5_spec.rb'
    
    row '.rspec'
    row '.rubocop.yml'
    row '.travis.yml'                     , command: 'delete', note: 'this was generated by bundle gem'
    row 'applet_name.gemspec'             , 'k_builder-webpack5.gemspec'
  ...
  def on_action
    ...
    # hotfix 'Upgrade default readme and ruby files, plus add support for, rubocop, guard to k_builder-webpack5'
  end if is_run == 1
