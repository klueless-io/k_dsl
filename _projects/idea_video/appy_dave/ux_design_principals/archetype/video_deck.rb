...
KDsl.blueprint :video_deck do
  settings do
    name                          parent.key
    video_type                    'thought'
    theme                         'appy_dave' # gratitude_bridge appy_dave beige black blood league moon night serif simple sky solarized white
  ...
  table :structure do
    ...
    row 'What Are Ux design principals?'
    row 'Why Do Ux design principals Work So Well?', points: []
    row 'Best Practices', points: [], aka: '7 Tips for Writing a Great ux_design_principal'
