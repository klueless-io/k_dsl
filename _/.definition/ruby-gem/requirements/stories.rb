...
KDsl.document :stories do
  ...
  table :stories do
    ...
    row :story, :current, 'As a {{settings.avatar}}, I can DO_SOMETHING, so that I QUALITY_OF_LIFE',
    [
      'Subtask'
    ], featured_position: 1
    ...
    [
      'Build and deploy gem to [rubygems.org](https://rubygems.org/gems/{{settings.application}})',
      'Attach documentation to [rubydoc.info](https://rubydoc.info/github/to-do-{{project.config.github_user}}/{{settings.application}}/master)'
    ]
