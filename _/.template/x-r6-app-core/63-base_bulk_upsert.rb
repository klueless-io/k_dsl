module BulkUpsert
  ...
  #      - Most API imports need custom approachs as they often have complex and unique rules
  #
  ...
  #
  # These constainst could be dynamic, this means that the index need not exist, you can have it created
  ...
  class BaseBulkUpsert
    ...
    # Will table reset (destruction) ever be allowed, becare of this setting
    ...
    def destroy_and_resequence_table()
      raise 'You cannot destroy this table' if !@can_destroy_table
    ...
    def sync(source_key: nil, spreadsheet_name: nil, worksheet_name: nil)
    end
