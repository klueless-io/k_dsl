...
class LogUtil
  ...
  def progress(pos = nil, section = nil)
    ...
    return LogHelper.progress_position
  end
  ...
  def exception(e)
    ...
    @rails_logger.info(e.message)
    @rails_logger.info(e.backtrace.join("\n"))
    # @rails_logger.debug(e.message)
    # @rails_logger.debug(e.backtrace)
