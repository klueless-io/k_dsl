...
kl_cmd 'create new rails application using standard rails 6 base docker klueless/rails6'
docker container run --rm -v $(pwd):/usr/src/app -it klueless/rails6 rails new . -T -d postgresql --force --webpack=react --skip-git --skip-action-mailer --skip-action-mailbox --skip-action-text
# rails new ../. -T -d postgresql --force --webpack=react --skip-git --skip-action-mailer --skip-action-mailbox --skip-action-text
# --skip-webpack-install
# docker container run --rm -v $(pwd):/usr/src/app -it klueless/web-{{dashify settings.application}} rails new . -T -d postgresql --force --webpacker --skip-action-mailer --skip-action-mailbox --skip-action-text
kl_cmd_end
