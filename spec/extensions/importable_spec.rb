...
#   subject { KDsl::Manage::Project.new(key, &block) }
...
#   let(:document2) { KDsl::Model::Document.new :ymen }

#   let(document)
#   a = KDsl::Model::Document.new(:a)
#   a.set_data({ a: 'bbb'} )
#   puts a.data
#   b = KDsl::Model::Document.new(:b)

#   fcontext 'extension not loaded' do
#     subject
#     describe '#import' do
#       expect(b).not_to respond_to(:import)
#     end
#   end

#   fit do
#     r = KDsl::Resources::Resource.instance(project: project, file: 'somedata.txt')
#     a = KDsl::Model::Document.new(:a)
#     a.set_data({ a: 'bbb'} )
#     puts a.data
#     b = KDsl::Model::Document.new(:b)
#     project.add_resource_document(r, a)
#     project.add_resource_document(r, b)
#     project.debug(format: :resource_document)

#     expect(b).not_to respond_to(:import)
#     KDsl::Model::Document.include(KDsl::Extensions::Importable)
#     puts b.import(a.key, a.type, a.namespace)
#   end
