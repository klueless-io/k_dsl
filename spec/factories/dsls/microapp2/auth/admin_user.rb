# Klue.artifact 'admin_user', visitors: [Klue::Dsl::ArtifactSettingsVisitor] do
...
#   write_data 'spec/_data/domain/common-auth/admin_user.json'
#   # write_data 'spec/_data/domain/common-auth/admin_user.yaml'

#   # write_meta 'spec/_data/domain/common-auth/admin_user-meta.json'
#   # write_meta 'spec/_data/domain/common-auth/admin_user-meta.yaml'
